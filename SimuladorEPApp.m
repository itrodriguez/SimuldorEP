classdef SimuladorEPApp < handle
%
% Usage:
%     app.SimuladorEPApp
  ...
  methods
    ...
    function startApp(obj)
        ...
        if nargout(@SimuladorEP) == 0  
            eval('SimuladorEP');
        else
			obj.AppHandle = eval('SimuladorEP');   
        end 
        % Increment the reference count by one    
        SimuladorEPApp.refcount(obj.Increment);
